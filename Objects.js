...
//     [smb]:"Key is of Symbol type",          //to add symbol key in object write the key within suare brackets
//     age:21,
//     location:"Kanpur",
//     email:"adi@gmail.com",
//     isLoggedIn:false
...
//console.log(course.mode);             //if I have to print it 10 times then I need to write it again and again

const {mode: m}=course          // de-structuring of objects
console.log(m);
